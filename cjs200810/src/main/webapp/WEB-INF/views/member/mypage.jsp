...
<div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px">
	<h2 class="w3-wide" style="text-align:center;">회 원 정 보</h2>
	<table id="mTable">
		<tr>
			<td><label for="id">아이디</label> </td>
			<td id="idText" colspan="2">
		...
		<tr>
			...
			<td id="nickText" colspan="2">${vo.nick}</td>
		</tr>
		<tr>
			<td><label for="birth">생년월일</label></td>
			<td><input type="text" name="birth" id="birth"  value="${vo.birth}" class="w3-input w3-border" readonly/></td>
		</tr>
		<tr>
			<td><label for="email1">이메일</label></td>
			<td>
				<input type="text" name="email1" id="email1" value="${email1}" class="smalltext"/>&nbsp;
				<b>@</b>&nbsp;
				<span id="email2Text"><input type="text" name="email2" id="email2" value="${email2}" class="smalltext" readonly/></span>
		...
		<tr>
			...
			<td>
				<input type="text" name="tel1" id="tel1" value="${tel1}" minlength="1" maxlength="3" size="17"class="smalltext"/><b>ㅡ</b>
				<input type="text" name="tel2" id="tel2" value="${tel2}" minlength="1" maxlength="4" size="17" class="smalltext"/><b>ㅡ</b>
				<input type="text" name="tel3" id="tel3" value="${tel3}" minlength="1" maxlength="4" size="17"class="smalltext"/>
			</td>
		</tr>
		<tr>
			<td><label>주소</label> </td>
			<td>
				<input type="text" id="sample4_postcode"  class="smalltext" name="zipCode" value="${zipCode}" placeholder="우편번호" readonly/>
				...
				<input type="text" id="sample4_roadAddress" class="w3-input w3-border" name="address1" value="${address1}" placeholder="도로명주소" readonly/><br/>
				<span id="guide" style="color:#999;display:none"></span>
				<input type="text" id="sample4_detailAddress" name="address2" class="w3-input w3-border" value="${address2}" placeholder="상세주소">
			</td>
		</tr>
	</table>
	<div style="padding-top:20px;">
		<input type="button" class="w3-button w3-blue w3-section w3-center" id="submitBtn" value="수정"/>
