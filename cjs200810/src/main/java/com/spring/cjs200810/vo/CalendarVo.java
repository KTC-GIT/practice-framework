...
public class CalendarVo {
	...
	public Map<String,Integer> today_info(CalendarVo cVo){
		Map<String,Integer> today_Data = new HashMap<String, Integer>();
		Calendar cal = Calendar.getInstance();
		cal.set(Integer.parseInt(cVo.getYear()),Integer.parseInt(cVo.getMonth()),1);
		...
		int search_year = Integer.parseInt(cVo.getYear());
		int search_month = Integer.parseInt(cVo.getMonth()) + 1;
	...
	//스케줄 사용시 사용할 생성자
	public CalendarVo(String year,String month,String date,String value,String schedule,String schedule_detail) {
